...
var popup = L.popup()
    .setLatLng([40.676455, -73.797030]) // Standalone popup location
...
var greenIcon = L.icon({
    iconUrl: 'https://cdn-icons-png.flaticon.com/128/10095/10095082.png',
    iconSize: [37, 37],       // Size of the icon
    iconAnchor: [18, 37],     // Anchor point at the bottom center of the icon
    popupAnchor: [0, -37]     // Popup appears above the icon
});
